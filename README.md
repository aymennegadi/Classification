...
This chapter provides the theoretical foundation required before studying classification algorithms.

**Topics covered:**

* Introduction to Machine Learning (AI vs. ML and the three learning paradigms)
* Supervised Learning (features, target variable, training and testing datasets)
